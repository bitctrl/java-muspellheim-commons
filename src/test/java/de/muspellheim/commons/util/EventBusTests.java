...
class EventBusTests {
	...
	void publish() throws Exception {
		...
		// Then
		assertAll(() -> assertEquals(Arrays.asList("Foo", "Bar"), stringEvents, "string events"),
	...
	void handlerThrowsException() throws Exception {
		...
		// Then
		assertAll(() -> assertEquals(Collections.singletonList("Foo"), stringEvents, "string events"),
	...
	void eventTypeHierarchy() throws Exception {
		...
		// Then
		assertAll(() -> assertEquals(Collections.singletonList(42), integerEvents, "integer events"),
