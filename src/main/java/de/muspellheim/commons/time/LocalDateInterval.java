...
public class LocalDateInterval {
	...
	/**
	 * Obtains an instance of {@code LocalDateInterval} from a start and end.
	 *
	...
	/**
	 * Obtains an instance of {@code LocalDateInterval} from a text string such as
	 * {@code
	 * 2007-12-03T10:15:30}.
	 *
	 * <p>
	 ...
	 *
	 * @param text the text to parse such as "2019-08-16T17:02/2019-09-09T08:50",
	 *             not null
	...
	public boolean contains(LocalDateInterval other) {
		return (start.isBefore(other.start) || start.equals(other.start))
	 ...
	 *
	 * @param other the interval to compare to, not null
	 * @return the interval between this an the other interval or null if there is
	 *         no gap
	 */
